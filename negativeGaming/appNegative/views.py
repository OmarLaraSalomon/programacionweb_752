...
def revi(request):
    ...
    return render(request, 'social/revision.html')


def quien(request):

    return render(request, 'social/quienes.html')
...
def revt(request):
    ...
    return render(request, 'social/revitecla.html')


def revm(request):
   

    return render(request, 'social/revimouse.html')


def revman(request):
   

    return render(request, 'social/revimando.html')


def revh(request):
    

    return render(request, 'social/revihead.html')
