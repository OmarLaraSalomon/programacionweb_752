...
urlpatterns = [
    ...
    url('^revisiones/$' , views.revi, name="revisiones"),
    url('^comentarios/$' , views.coment, name="comentarios"),
    url('^quienes/$' , views.quien, name="quienes"),
    url('^listas/$' , views.lista, name="listas"),
    url('^reviteclas/$' , views.revt, name="reviteclas"),
    url('^revimouses/$' , views.revm, name="revimouses"),
    url('^revimandos/$' , views.revman, name="revimandos"),
    url('^reviheads/$' , views.revh, name="reviheads"),
